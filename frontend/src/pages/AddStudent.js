...
const AddStudentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsValid(true);
    try {
      await axios.post('https://student-management-system-y7so.onrender.com/students', formData);
    ...
    reader.onload = async (e) => {
      ...
      try {
        for (const student of data) {
          await axios.post('https://student-management-system-y7so.onrender.com/students', student);
        }
